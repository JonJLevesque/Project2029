...
- **Project 2029 Connection:**
  - [Chapter 28: Legal Accountability](../../Section6_Safeguarding_Democracy_And_Accountability/Chapter_28_Legal_Accountability_for_Subversion_of_Democracy.md) - When do presidents cross constitutional lines?
  - [Chapter 29: Structural Safeguards](../../Section6_Safeguarding_Democracy_And_Accountability/Chapter_29_Structural_Safeguards.md) - Emergency powers and their limits
...
- **Topic:** Electoral Systems, Voter Participation
- **Project 2029 Connection:**
  - [One-Pager: Abolish Electoral College](../One-Pagers/03_Abolish_Electoral_College.md)
  - [One-Pager: Ranked-Choice Voting](../One-Pagers/12_Ranked_Choice_Voting.md)
  - [One-Pager: Automatic Voter Registration](../One-Pagers/10_Automatic_Voter_Registration.md)
  - [Chapter 29: Ban Gerrymandering](../../Section6_Safeguarding_Democracy_And_Accountability/Chapter_29_Structural_Safeguards.md)
- **Activities:**
  - **Simulation:** Run a mock election using ranked-choice voting vs. first-past-the-post
  - **Data Analysis:** Compare voter turnout in states with vs. without automatic registration
  - **Debate:** Should every vote count equally? (Electoral College debate)
  - **Mapping Exercise:** Identify gerrymandered districts in your state

**Unit 3: Money in Politics**
- **Topic:** Campaign Finance, Political Influence
- **Project 2029 Connection:**
  - [One-Pager: Overturn Citizens United](../One-Pagers/01_Citizens_United_Reversal.md)
  - [One-Pager: Publicly Funded Elections](../One-Pagers/07_Publicly_Funded_Elections.md)
  - [One-Pager: Ban Lobbying](../One-Pagers/06_Ban_Lobbying.md)
  - [Chapter 17: DOJ Campaign Finance Enforcement](../../Section3_The_General_Welfare/Chapter_17_Department_of_Justice.md)
- **Activities:**
  - **Research Project:** Track campaign contributions for your district's representative
  - **Case Study Analysis:** *Citizens United v. FEC* - Read the decision and dissent, evaluate arguments
  - **Policy Debate:** Democracy vouchers vs. traditional campaign finance
  - **Follow the Money:** Use OpenSecrets.org to analyze influence

**Unit 4: Media Literacy and Information**
- **Topic:** Media, Propaganda, Disinformation
- **Project 2029 Connection:**
  - [One-Pager: Restore Fairness Doctrine](../One-Pagers/05_Restore_Fairness_Doctrine.md)
  - [One-Pager: Social Media Transparency](../One-Pagers/14_Social_Media_Transparency.md)
  - [One-Pager: Ban Micro-Targeted Ads](../One-Pagers/15_Ban_Micro_Targeted_Political_Ads.md)
  - [One-Pager: Political Deepfake Ban](../One-Pagers/20_Political_Deepfake_Ban.md)
  - [Chapter 11: Civic Education](../../Section3_The_General_Welfare/Chapter_11_Department_of_Education.md)
- **Activities:**
  - **Deepfake Detection Lab:** Analyze real and fake political videos
  - **Algorithm Audit:** Students track what political ads they see on social media vs. classmates
...
- **Project 2029 Connection:** Every major democratic expansion required organized movements
  - [Activist Study Guide](Activist_Study_Guide.md) - Modern organizing tactics
  - [Chapter 30: Fundamental Transformation](../../Section6_Safeguarding_Democracy_And_Accountability/Chapter_30_Fundamental_Democratic_Transformation.md) - Historical precedents section
- **Activities:**
...
- **Project 2029 Connection:**
  - 6 amendments proposed (28th-33rd) in [Chapter 30](../../Section6_Safeguarding_Democracy_And_Accountability/Chapter_30_Fundamental_Democratic_Transformation.md)
- **Activities:**
  ...
  - **Comparative Study:** Project 2029 amendments vs. failed amendments (ERA, DC statehood, balanced budget)
...
- [Chapter 30: Fundamental Transformation](../../Section6_Safeguarding_Democracy_And_Accountability/Chapter_30_Fundamental_Democratic_Transformation.md) (Introduction)
...
**Materials:**
- [One-Pager: Abolish Electoral College](../One-Pagers/03_Abolish_Electoral_College.md)
- [National Popular Vote Compact](https://www.nationalpopularvote.com/) explainer
- Electoral College map and recent election data
...
- [One-Pager: Overturn Citizens United](../One-Pagers/01_Citizens_United_Reversal.md)
- [One-Pager: Publicly Funded Elections](../One-Pagers/07_Publicly_Funded_Elections.md)
- Simulation handouts (roles, budgets, rules)
...
**Materials:**
- [One-Pager: Political Deepfake Ban](../One-Pagers/20_Political_Deepfake_Ban.md)
- Examples of deepfakes (Tom Cruise TikToks, political examples)
...
- **Process:**
  ...
  - Incorporate Project 2029 amendments or counter-proposals
- **Deliverables:**
...
**Prompt:**
Choose one Project 2029 One-Pager. Write a 3-5 page analytical essay addressing:
...
**Prompt:**
Compare the US Constitution to another democratic nation's constitution on ONE structural feature addressed in Project 2029.
...
**Scenario:**
You are testifying before the House Committee on Government Reform. The committee is considering legislation to implement one Project 2029 reform.

**Task:**
Prepare and deliver 5-minute testimony, then answer questions from committee (classmates).
...
- Lesson 1 (from above)
- Homework: Read [Quick Reference Guide](../Quick_Reference_Guide.md)

**Day 3-4: Historical Context**
- Mini-lessons: Progressive Era reforms, New Deal, Civil Rights Act, Watergate reforms
- Read: [Chapter 30 historical precedents](../../Section6_Safeguarding_Democracy_And_Accountability/Chapter_30_Fundamental_Democratic_Transformation.md#historical-precedents)
